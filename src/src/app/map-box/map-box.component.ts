...
//import { MatButtonToggleModel } from '@angular/material/button-toggle';
...
export class MapBoxComponent {
  ...
  latitude: number = 46.2276; // latitude à l'initialisation
  longitude: number = 2.2137; // longitude à l'initialisation
