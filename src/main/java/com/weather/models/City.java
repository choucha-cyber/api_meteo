...
//    private String iso2;
	...
	public City(String cityName, String cityAscii, Double latitute, Double longitude, String country,
			String iso2) {
		super();
	...
	public String toString() {
		return "WorldCity [id=" + id + ", cityName=" + cityName + ", cityAscii=" + cityAscii + ", latitute=" + latitute
