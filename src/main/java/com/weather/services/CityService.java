...
public class CityService implements CityServiceInterface{
    ...
    @Override
    public Page<City> getCityByCityName(String cityName, Pageable pageable) {
    	return cityRepo.findCitiesByCityNameContainingIgnoreCase(cityName, pageable);
    }

    @Override
    public Page<City> getCityPage(Pageable pageable) {
    	return cityRepo.getCitiesBy( pageable);
    }
